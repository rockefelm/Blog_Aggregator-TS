...
async function main() {
  ...
  registerCommand(registeredCommands, "addfeed", middlewareLoggedIn(handlerAddFeed));
  ...
  registerCommand(registeredCommands, "browse", middlewareLoggedIn(handlerBrowse));
